  ...
  return (
    <div>
      ...
      <ResponsiveContainer width="100%" height={400}>
        <ScatterChart>
          <CartesianGrid />
          {/* You can adjust the XAxis and YAxis to different fields */}
          <XAxis
            dataKey="cases"
            name="Cases"
            type="number"
            label={{ value: "Cases", position: "insideBottomRight", offset: -5 }}
          />
          <YAxis
            dataKey="deaths"
            name="Deaths"
          ...
          <Legend />
          <Scatter name="Dengue Data" data={dengueData} fill="#8884d8" />
        </ScatterChart>
      </ResponsiveContainer>
    </div>
  );
